...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_gpio_led_switch, and set properties
  set axi_gpio_led_switch [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_led_switch ]
  set_property -dict [ list \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net PmodBLE_0_Pmod_out [get_bd_intf_ports ja] [get_bd_intf_pins PmodBLE_0/Pmod_out]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports shield_dp0_dp19] [get_bd_intf_pins axi_gpio_shield/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO1 [get_bd_intf_ports led_4bits] [get_bd_intf_pins axi_gpio_led_switch/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports shield_dp26_dp41] [get_bd_intf_pins axi_gpio_shield/GPIO2]
  connect_bd_intf_net -intf_net axi_gpio_led_switch_GPIO2 [get_bd_intf_ports dip_switches_4bits] [get_bd_intf_pins axi_gpio_led_switch/GPIO2]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M01_AXI [get_bd_intf_pins axi_gpio_shield/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M02_AXI [get_bd_intf_pins axi_gpio_led_switch/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M03_AXI [get_bd_intf_pins PmodBLE_0/S_AXI_GPIO] [get_bd_intf_pins microblaze_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M04_AXI [get_bd_intf_pins PmodBLE_0/S_AXI_UART] [get_bd_intf_pins microblaze_0_axi_periph/M04_AXI]
  ...
  # Create port connections
  connect_bd_net -net PmodBLE_0_BLE_uart_interrupt [get_bd_pins PmodBLE_0/BLE_uart_interrupt] [get_bd_pins microblaze_0_xlconcat/In0]
  connect_bd_net -net axi_gpio_shield_ip2intc_irpt [get_bd_pins axi_gpio_shield/ip2intc_irpt] [get_bd_pins microblaze_0_xlconcat/In3]
  ...
  connect_bd_net -net rst_clk_wiz_0_100M_peripheral_aresetn [get_bd_pins PmodBLE_0/s_axi_aresetn] [get_bd_pins axi_gpio_led_switch/s_axi_aresetn] [get_bd_pins axi_gpio_shield/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins microblaze_0_axi_periph/M07_ARESETN] [get_bd_pins microblaze_0_axi_periph/M08_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40010000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_gpio_led_switch/S_AXI/Reg] SEG_axi_gpio_led_push_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40000000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_gpio_shield/S_AXI/Reg] SEG_axi_gpio_shield_Reg
